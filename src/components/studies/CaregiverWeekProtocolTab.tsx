...
export const CaregiverWeekProtocolTab = () => {
  return (
    <ProtocolViewer
      ...
      documentContent={`1. Introduction
2. Study Objectives
...
Participant Profile:Primary Caregivers: Individuals primarily responsible for the care of a person with dementia.
...
Recruitment Strategy:Primary caregivers will be recruited through relevant organizations, support groups, and online platforms.
