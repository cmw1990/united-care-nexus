...
export const ProtocolTab = () => {
  const protocolContent = `# A Week in the Life of Dementia Caregivers and Days in the Life of Dementia Caregivers: An Experience-Based Co-Design Study to Develop Digital Resources Supporting Caregiver Networks
...
**Interactive Survey Data:** Will be collected and stored securely.
