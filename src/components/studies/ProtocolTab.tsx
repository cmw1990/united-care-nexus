...
dyad[1,2]. Within these networks, eﬀective communication, coordination, and collaboration (CCC) are fundamental for optimizing care quality and sustaining caregiver well-being
[3, 4]. However, maintaining eﬀective CCC frequently encounters significant barriers, including geographical distance, time constraints, and fragmented information flow[5]. In
response, numerous electronic health (eHealth) technologies—conceptualized in this research as digital "bridges" due to fragmented terminology—have been developed in recent years to connect network members and facilitate interaction[6,7].
While many such bridges exist, the evidence regarding their types, features, eﬀectiveness, and factors influencing adoption by diverse caregiver networks appears fragmented. Significant challenges have been reported in the development and adoption of these
...
technical literacy, privacy concerns, etc), or both [10,11,34]. Recent advancements in Artificial Intelligence (AI) technologies, particularly Large Language Models (LLMs), holds potential to address some persistent gaps (e.g., interoperability, information input and management burden, the dilemma between complex system required to be eﬀective and ease
of use or navigation) identified by earlier research [12, 21], but their potential and acceptance in this context also remain largely unclear [13].
...
bridges developed; the caregiver roles and network members they connect; the methodologies employed in their development and evaluation; the features and techniques utilized to address CCC barriers and adoption challenges within multi-caregiver networks;
...
of AI among caregivers. The ultimate goal of this research is to synthesize findings to inform future research, technology development, and implementation strategies focused on
...
in home-based dementia care), Concept (eHealth "bridges" facilitating network interaction for CCC or support), and Context (home-based dementia care settings) framework.
...
covering source details, bridge characteristics, development processes, evaluation methods, eﬀectiveness, stakeholder perspectives, integration capabilities, technological evolution, and implementation factors. The extracted data will be synthesized narratively, structured around the review questions and the conceptual framework of digital "bridges."
Keywords: Dementia, Alzheimer Disease, Caregivers, Informal Caregivers, Family Caregivers, Caregiving Network, eHealth, Mobile Health, Technology, Communication, Coordination, Collaboration, Social Support, Psychosocial Support, Implementation Science,
...
as feasible, often the preferred setting for individuals and families[17], typically involve intricate networks of individuals extending well beyond the primary caregiver-person with
...
The eﬀective functioning of such a care network relies critically on adequate communication, coordination, and collaboration (CCC) among its members [3,4]. Members require
timely and relevant information—updates on health status, care strategies, schedules—to
contribute eﬀectively. Eﬀective teamwork ensures shared understanding, facilitates appropriate task distribution, enables timely information exchange, and leads to more integrated care [4]. However, achieving seamless CCC within these often dynamic and geographically dispersed networks faces numerous hurdles [5]. Challenges include coordinating schedules, sharing sensitive information securely, managing diﬀering knowledge levels or digital literacy, navigating interpersonal dynamics, and overcoming system fragmentation [5,19]. An asymmetry often exists, with secondary caregivers potentially lacking direct information access and relying on the primary caregiver, who may be overburdened and struggle to manage communication flows across the network [1,5].
...
"bridges," designed to connect members of the care network and facilitate smoother interactions. These digital bridges, encompassing a range of tools from web-based platforms and mobile applications [7] to potentially more sophisticated systems leveraging
...
coordination platforms focusing on task management, shared calendars [22] ; care collaboration platforms designed to support joint care planning and communication about
critical decisions [4]; knowledge and education systems aiming to improve dementia literacy and caregiving skills across the network [24]; platforms oﬀering tailored psychosocial
support resources or peer connection opportunities for caregivers [23,25, 30, 33]; systems incorporating location tracking or wandering alert features for safety management
[34]; or more comprehensive care management systems that integrate multiple functionalities into a single interface [7].
...
collaboration within any care network presuppose a foundational level of shared understanding among the caregivers. Yet, studies consistently indicate suboptimal dementia
knowledge among the general public and many family caregivers, including prevalent
misconceptions about the condition's nature, progression, management [26]. This knowledge gap can impede informed participation in care decisions and negatively aﬀect interactions within the network, undermining the very foundation upon which collaborative
...
less familiar with technology, may lack the necessary skills, confidence, or access to effectively engage with online resources or digital tools, even when potentially beneficial.
...
of the entire relevant network—and not just the primary caregiver—to adopt and consistently use the technology collectively [10,11, 30]. Adoption can fail if network members
...
(LLMs), has generated considerable discussion regarding its potential to transform various aspects of healthcare, including dementia care and caregiving support [12,13]. AI
holds theoretical potential to enhance interoperability between systems, bridging information silos, and easing the burden of information input, retrieval, management and presentation for caregivers – potentially addressing gaps that currently seem "too far" to bridge
eﬀectively [12].
However, the application of AI specifically aimed at supporting caregiver networks and
enhancing CCC among multiple caregivers appears to be in its very early stages. Significant challenges likely remain before AI can be eﬀectively leveraged for this purpose.
...
Furthermore, considerations regarding data privacy, the potential for algorithmic bias impacting care recommendations or task allocation, and the overall trustworthiness of AI
systems may act as significant deterrents for users [13,31]. Caregivers may be hesitant to
accept or rely on "smarter" bridges built with AI, potentially rendering these advanced solutions another form of "bridge too far" in practice, despite their technical might. The
adoption challenges already faced by simpler eHealth tools related to trust and acceptance are likely to be amplified with AI [10, 13].
Therefore, a key objective of this scoping review is to map the current state of AI integration in network support tools. This involves identifying if AI applications are reported to
address previously identified gaps, exploring evidence on user acceptance and perceived
value, understanding if AI represents a conceptual "bridge too far," and mapping any reported methods (e.g., explainable AI techniques) used to enhance trust and acceptance,
along with their described eﬀectiveness.
Rationale and Aims for the Scoping Review
The rationale for conducting this scoping review stems from the fragmentation of evidence regarding eHealth solutions designed to support the broader dementia care network and the persistent challenges ("bridge too far") aﬀecting their development and
adoption [7,8,10]. Utilizing the "bridges" metaphor, this review will systematically identify,
characterize, and map the range of eHealth applications that have been developed, evaluated, or proposed to facilitate CCC and provide social or psychosocial support among
...
used for their development and evaluation; the reported evidence regarding their eﬀectiveness and acceptance; the barriers and facilitators influencing their adoption and sustained use; features or techniques employed specifically to address known barriers in
...
overview of the evidence base. This synthesis will serve to inform future research priorities, guide the development of more eﬀective and user-centered technologies, and support implementation strategies directed towards creating "eﬀective bridges that last."
3. Methods
3.1. Protocol Design
This scoping review will be conducted in accordance with the JBI methodology [14] for
scoping reviews and will be reported following the Preferred Reporting Items for Systematic reviews and Meta-Analyses extension for Scoping Reviews (PRISMA-ScR) guidelines
15]. The review will proceed through the following stages: (1) Defining objectives and
questions; (2) Aligning inclusion criteria; (3) Planning evidence search, selection, extraction, and presentation; (4) Searching; (5) Selecting; (6) Extracting; (7) Analyzing and Summarizing evidence.Stage 1: Defining and aligning the objectives and questions
...
framework, guided by the review's objectives and the conceptualization of eHealth interventions as digital "bridges" connecting members of the care network:
• Population: Caregivers (primary caregivers, secondary/other informal caregivers,
formal home-based care workers, respite providers, volunteers, community support personnel, and relevant healthcare professionals involved in the care network
...
to facilitate interaction among multiple caregivers within the care network, conceptualized in this research as digital "bridges". This includes technologies supporting
...
features and functionalities incorporated within these applications designed to facilitate CCC, provide social/psychosocial support, manage information, or coordinate tasks among network members? What features have been developed to enable personalized/contextualized privacy/information access control and what features have been developed to enhance the explainability and transparency of the
system?
...
stakeholders involved in the design/development and what stakeholders stakeholders were involved in the design/development?
5. How were these "bridges" evaluated? - What evaluations were conducted on these
bridges?(e.g. usability , feasibility, acceptability, adoption, eﬀectiveness, implementation)?
6. How eﬀective are the "bridges" at bridging? - What is the reported evidence regarding the eﬀectiveness or impact of these bridges on outcomes related to the
caregiver network (e.g., improved communication, coordination, collaboration, reduced conflict), caregiver well-being (e.g., burden, stress, social support), or potentially PwD outcomes (e.g., quality of care, safety)?
7. How are these "bridges" perceived and received? - What are the reported perceptions and experiences of stakeholders on using these bridges, including needs,
...
9. How have these bridges evolved over time? - How have the features, functionalities, and underlying technologies used in these bridges changed over the review
...
AI to address previously identified gaps and how do caregivers perceive and accept these AI-driven features?
...
and implementation?
Step 2: Developing and aligning the inclusion criteria with the objective and questions
Studies will be included if they meet the following criteria:
• Empirical studies (quantitative, qualitative, or mixed-methods) evaluating or detailing the design, development process, feasibility, usability, acceptability, evaluation
methodology, implementation, eﬀectiveness/outcomes, evolution, or sustainability
of eHealth applications supporting interaction among multiple caregivers in dementia home care.
...
• Studies focusing exclusively on institutional settings (e.g., nursing homes, hospitals) without a clear link or interface to the home-based care network via the
...
• Technologies designed solely for use by the person with dementia, unless they incorporate specific functionalities for interaction or information sharing among multiple caregivers.
• eHealth interventions explicitly targeting only a single caregiver or only the caregiver-person with dementia dyad, without features designed for broader network interaction or communication with other members in the care network.
...
• Review articles, editorials, commentaries, letters, conference abstracts without sufficient empirical data. Protocols of studies (unless reporting preliminary findings
...
syntax, Boolean operators (AND, OR), proximity operators (where available), and truncation/wildcard symbols.
...
Spouse, Respite, Child, Children, friend*, neighbour*, volunteer*, informal care, informal caregiver*, home care worker*, home-care worker*, day care worker*, day
care worker*, nurse*, team, multi-user*, multiple user*
• Concept (eHealth/Technology/Bridges): eHealth, mHealth, digital health, telehealth, telemedicine, technology, mobile application, app, web, internet, online,
platform, portal, software, artificial intelligence, AI, llm, chatbot, bot, smart, information sharing, chat group, chatgroup, task management, shared calendar, care
...
Information Sources:
1. Academic Electronic Databases: Searches will be conducted in the following databases: PubMed, Embase, Scopus, ACM Digital Library, and IEEE Xplore. These databases provide broad coverage across medical, psychological, social science, nursing,
allied health, and computing/engineering literature.
2. Grey Literature Sources: To capture non-peer-reviewed materials and reports not indexed in academic databases, systematic searches will be performed in Google Scholar,
first 500 papers will be retrieved for further selection.
...
screen titles and abstracts against the predefined eligibility criteria. Before commencing independent screening, R1 and R2 will conduct a calibration exercise on
a sample of abstracts (e.g., 50-100) to ensure consistent interpretation and application of the criteria. Any disagreements during calibration will be discussed and
criteria clarified as needed.
• Potentially relevant articles identified during title/abstract screening will be retrieved for full-text review. R1 and R2 will then independently assess the full texts
against the eligibility criteria.
• Conflict Resolution: Any disagreements between R1 and R2 at either the title/abstract or full-text screening stage will be resolved through discussion and consensus. If consensus cannot be reached, a third reviewer will be consulted to make
the final decision.
• Documentation: Reasons for excluding studies at the full-text stage will be documented. The entire selection process, including the number of records identified,
screened, assessed for eligibility, and included, will be reported using a PRISMAScR flow diagram.
...
address the specific review objectives and questions. The form will be piloted by both reviewers on a small subset of included studies (e.g., 3-5 studies) and refined for clarity and
...
the final version of the data charting form. Any discrepancies identified during the extraction process will be resolved through discussion between the two reviewers. The data
...
3. Network structure/size targeted (if specified)
...
addressing Communication, Coordination, Collaboration, Social Support,
Psychosocial Support, Safety/Monitoring, etc, that are designed for multi-user
usage
2. Single-user support features: Features
designed to support individual caregivers in the care network, e.g.Knowledge Provision
...
role-based access
5. "Explainability" and "Transparency"Features: Features designed to explain or
reveal the working mechanisms of the
technology
1. Development methodology
2. Types of Stakeholders involved in development (e.g., caregivers, PwD, clinicians)
3. Number of Stakeholders involved in development
...
3. Outcome domains assessed (e.g., usability, feasibility, adoption, CCC effectiveness, caregiver burden, well-being)
...
2. Impact on information flow/silos, information input/retrieval burden.
Evolution & Sustainability ("Are the
Bridges Still standing?")
1. Information on intervention updates, different versions, or evolution over time
2. Current operational status (e.g., active,
discontinued, research-only), Reported
funding model or sustainability plan
3. Reported funding model or sustainability plan (if available)
4. Factors associated with successful realworld adoption/implementation
...
• Approach: A narrative synthesis will be employed, structured around the ten research questions and the "digital bridges"/"bridge too far" conceptual framework.
...
• Integration of Findings: Synthesis will integrate quantitative summaries and qualitative themes related to each research question.
• Reporting: Results presented via narrative text and tables (summarizing study/
bridge characteristics). A PRISMA-ScR flow diagram will document study selection. The narrative will address each research question, summarizing key findings,
...
types of eHealth "bridges" that have been developed and evaluated, their specific features, the network members they target, and the methodologies used to assess them. A
...
on the potential role of AI in this domain, mapping its current applications and the associated challenges regarding acceptance and trust.
A scoping review methodology was chosen as the appropriate approach for this undertaking. It allows for the clarification of key concepts (like the diﬀerent forms of "bridges"
...
network perspectives in dementia care networks: a multi-informant study on the mismatch between supply and demand of social support. Int Psychogeriatr. 2017
Dec;29(12):2065-2075. doi: 10.1017/S1041610217001612. PMID: 28606195.
2. Brodaty H, Donkin M. Family caregivers of people with dementia. Dialogues Clin Neurosci. 2009;11(2):217-28. PMID: 19585953; PMCID: PMC3181915.
...
KH. Eﬀects of a Comprehensive Intervention Program With Cooperative Planning Between Diﬀerent Health Care Professionals and Family Caregivers on the Health Outcomes
...
are they implementation-ready? Internet Interv. 2019 Oct 29;18:100260. doi: 10.1016/j.invent.2019.100260. PMID: 31700753; PMCID: PMC6821733.
9. Hübner U, Thye J, Blaser R, Babitsch B, Hüsers J, Egbert N, et al. Barriers and Facilitators for the Implementation of eHealth Services: Systematic Literature Analysis and Expert Interviews. JMIR Med Inform. 2019 Nov 22;7(4):e14197. doi: 10.2196/14197. PMID:
31755571; PMCID: PMC6914248.
10. Peek STM, Wouters EJM, van Hoof J, Luijkx KG, Boeije HR, Vrijhoef HJM. Factors influencing acceptance of technology for aging in place: a systematic review. Int J Med Inform. 2014 Apr;83(4):235-48. doi: 10.1016/j.ijmedinf.2014.01.004. Epub 2014 Jan 20.
PMID: 24529817.
...
12. Chen Y, Lehmann CU, Malin B. Digital Information Ecosystems in Modern Care Coordination and Patient Care Pathways and the Challenges and Opportunities for AI Solutions. J Med Internet Res. 2024 Dec 2;26:e60258. doi: 10.2196/60258. PMID: 39622048;
PMCID: PMC11650087.
13. van der Vaart R, van der Ham A, van der Velde M, van der Weide L, Peek STM,
Wouters EJM. Anticipating Implications to Complement Co-Design: An Empirical Exploration in the Context of Designing Artificial Intelligence Technology for Dementia Care.
JMIR Hum Factors. 2024 Jul 31;11:e54413. doi: 10.2196/54413. PMID: 39083474; PMCID: PMC11331028.
14.Peters MDJ, Godfrey C, McInerney P, Munn Z, Tricco AC, Khalil H. Chapter 11: Scoping Reviews (2020 version). In: Aromataris E, Munn Z (Editors). JBI Manual for Evidence
...
Horsley T, Weeks L, Hempel S, Akl EA, Chang C, McGowan J, Stewart L, Hartling L, Aldcroft A, Wilson MG, Garritty C, Lewin S, Godfrey CM, Macdonald MT, Langlois EV,
...
Sampson EL, Samus Q, Schneider LS, Selbæk G, Teri L, Mukadam N. Dementia prevention, intervention, and care: 2020 report of the Lancet Commission. Lancet. 2020 Aug
...
Aging. 2019 Jan 25;2(1):e12192. doi: 10.2196/12192. PMID: 31985028; PMCID: PMC6718104.
20. Eysenbach G. What is e-health? J Med Internet Res. 2001;3(2):E20. doi: 10.2196/
jmir.3.2.e20. PMID: 11720962; PMCID: PMC1761894.
21. Boessen ABCG, Verwey R, Duymelinck S, van Rossum E. An Online Platform to Support the Network of Caregivers of People with Dementia. J Aging Res.
...
an online social support intervention for caregivers of people with dementia (Inlife): A randomized controlled trial. J Med Internet Res. 2022 Dec 7;24(12):e38656. doi:
10.2196/38656. PMID: 36476485; PMCID: PMC9779530.
24. Levinson AJ, Ayers S, Butler L, Papaioannou A, Marr S, Sztramko R. Barriers and Facilitators for the Implementation of a Web-Based Dementia Caregiver Education Intervention (iGeriCare) in Clinical Practice: Qualitative Study. JMIR Aging. 2020 Oct
...
26. Cahill S, Pierce M, Werner P, Darley A, Bobrowicz A. A systematic review of the public's knowledge and understanding of dementia. Alzheimer Dis Assoc Disord. 2015 Jan-
...
28. Alqahtani A, Alshamrani M, Alqahtani N, Alshamrani A. Information Technology Applications to Support Informal Caregivers of Older Adults: Systematic Review. JMIR Aging. 2024 Jan 18;7:e57393. doi: 10.2196/57393. PMID: 38236517; PMCID: PMC10837620.
29. Kruse CS, Argueta DA, Lopez L, Nair A. Patient and provider attitudes toward the use
of patient portals for the management of chronic disease: a systematic review. J Med Internet Res. 2015 Feb 20;17(2):e40. doi: 10.2196/jmir.4015. PMID: 25700565; PMCID:
PMC4376233.
30. Christie HL, Dam AEH, van Boxtel M, Köhler S, Verhey F, de Vugt ME. Lessons
Learned From an Eﬀectiveness Evaluation of Inlife, a Web-Based Social Support Intervention for Caregivers of People With Dementia: Randomized Controlled Trial. JMIR Aging.
...
Healthc J. 2019 Jun;6(2):94-98. doi: 10.7861/futurehosp.6-2-94. PMID: 31363612; PMCID: PMC6616181.
...
R. Uptake and Use of Care Companion, a Web-Based Information Resource for Supporting Informal Carers of Older People: Mixed Methods Study. JMIR Aging. 2023 Sep
...
me feel like I wasn't alone in the darkness": exploring dementia care network communication and coordination through a digital health platform. J Am Med Inform Assoc. 2022
  ...
  return (
    <div className="prose max-w-none">
      <ProtocolViewer 
        ...
        fileName="BeyondTheCareScoping_Protocol.txt"
      />
    </div>
  );
};
