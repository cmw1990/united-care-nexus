  ...
  return (
    <MainLayout>
      <div className="flex flex-col gap-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight mb-2">{t('study2.title').replace("Optional: Optional:", "Optional:")} /</h1>
        </div>
        ...
        <Tabs defaultValue="protocol" className="w-full">
          ...
          <TabsContent value="protocol" className="border rounded-md p-4 mt-4">
            <div className="prose max-w-none">
              <h1>{t('study2.title').replace("Optional: Optional:", "Optional:")} /</h1>
            </div>
          </TabsContent>
